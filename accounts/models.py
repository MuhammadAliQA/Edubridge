...
class PaymentSubmission(models.Model):
    ...
    payer_name = models.CharField(max_length=120, blank=True, verbose_name="To'lov qiluvchi")
    payer_phone = models.CharField(max_length=50, blank=True, verbose_name="Telefon (ixtiyoriy)")
    transaction_ref = models.CharField(max_length=120, blank=True, verbose_name="Tranzaksiya ID")
    receipt_url = models.URLField(blank=True, verbose_name="Chek havolasi")
